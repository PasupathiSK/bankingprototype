...
-->
	...
	<ul class="topnav">
		...
		<li>
			...
			<i class='fas fa-house-user' style='font-size:30px;'><input type="submit" value="Home" class="dropbtn"></i>
			</form>
...
<input type="submit" value="Logout" class="top">
		...
		<menu style="position: fixed; left: 550px;top:45px;" >
			...
			<form action="<%=request.getContextPath()%>/SetRequestAccountStatus"
				...
				<i class='fas fa-landmark' style='font-size:30px'><input type="submit" value="Request" class="dropbtn" /></i>
			</form>
		</li>
		
		<li><div class="dropdown">
				<button class="dropbtn"><i class='fas fa-landmark' style='font-size:20px'>Transaction</i></button>
