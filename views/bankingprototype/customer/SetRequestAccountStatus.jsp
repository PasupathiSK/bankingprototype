...
<body>
	...
	<a>
		...
		<flable><b style="font-size:20px;">Account Number:</b></flable>
			<select name="accountNumber" style="border:none;width:50%;background:none;color:black;font-size:16px;padding:22px 50px;">
		...
		<div class="user-box">
			...
			<textarea name="description" rows="4" cols="50"  style="border-color:black;width:100%;background:none;padding:30px 80px;">
