...
<h1 style="font-size:30px;color:#DB4437;">Block Customer</h1>
<a>
...
<div class="user-box">
		<flable><b style="font-size:20px;">Choice:</b></flable>
			<select name="choice" style="width:50%;background:none;color:black;font-size:16px;padding:22px 50px;border-top: 1px solid #fff;
    border-left: 1px solid #fff;
    border-right: 1px solid #fff;">
