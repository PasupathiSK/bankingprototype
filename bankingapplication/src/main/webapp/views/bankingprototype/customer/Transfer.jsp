...
<div class="container">
<div class="login-box">
	<h1 style="font-size:30px;color:#DB4437;">TRANSACTION</h1>
	<a>
	<form action="transferProcess" method="post">
	<a>	<div class="user-box">
		<flabel><b style="font-size:20px;">From:</b></flabel> 
		<select name="accountNumber" style="width:100%;background:none;font-size:16px;padding:10px;">
		...
		<div class="user-box">
			<flabel><b style="font-size:20px;">To:</b></flabel> <input type="number" name="toAccountNumber" required/>
		</div>
		<div class="user-box">
			<flabel><b style="font-size:20px;">Amount:</b></flabel> <input type="number" name="amount" min="0" required/>
		</div>
